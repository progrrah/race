...
////Колеса3
Point carWheelPoint9 = {0.08, 0.1};
Point carWheelPoint10 = {0.08, 0.15};
Point carWheelPoint11 = {0.1, 0.15};
Point carWheelPoint12 = {0.1, 0.1};

////Колеса4
Point carWheelPoint13 = {0.08, -0.1};
Point carWheelPoint14 = {0.08, -0.05};
Point carWheelPoint15 = {0.1, -0.05};
Point carWheelPoint16 = {0.1, -0.1};
...
container_type<container_type<double>> windowColor = {
    {0.1, 0.3, 0.3}, {0.1, 0.3, 0.3}, {0.1, 0.3, 0.3}, {0.1, 0.3, 0.3},
    {0.1, 0.3, 0.3}, {0.1, 0.3, 0.3}, {0.1, 0.3, 0.3}, {0.1, 0.3, 0.3},
